---
title: "Mapa de conectividad de grupos funcionales de aves en otros hábitats en el Corredor Biológico Interurbano Rio Torres"
output: 
...
url_raster_probabilidad_conectividad <-
  "https://raw.githubusercontent.com/atlas-servicios-ecosistemicos-gam/datos/master/conectividad/cbirt/otras/PROBABILIDAD_CONECTIVIDAD_OTRAS_TORRES_WEB.TIF"

url_agfs_teselas <-
  "https://services9.arcgis.com/RrvMEynxDB8hycVO/arcgis/rest/services/gam_conectividad_parches_esenciales_importantes_otras_torres/FeatureServer/0"

url_agfs_rutas <-
  "https://services9.arcgis.com/RrvMEynxDB8hycVO/arcgis/rest/services/gam_conectividad_rutas_conectividad_otras_torres/FeatureServer/0"
...
# Esencialidad
bins_esencialidad <- c(0, 0.002481, 0.006301, 0.009606, 0.024991, Inf)
...
# Importancia
bins_importancia <- c(0, 76274645.50, 255451277.50, 483876653.90, 844641504.49, Inf)
...
leaflet() %>%
  ...
  addLayersControl(
    ...
    overlayGroups = c("Límite del CBIRT", "Probabilidad de conectividad", "Teselas esenciales", "Teselas importantes", "Rutas de conectividad"),
